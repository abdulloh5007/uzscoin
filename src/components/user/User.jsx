...
function User() {
    ...
    return (
        <div className='user'>
            ...
            {secret === 'secret123' && (
                <Button onClick={handleLogOut} className='myBtn' variant='outlined'>Log Out</Button>
            )}
            <Box sx={{ width: '100%' }}>
                ...
                <CustomTabPanel value={value} index={0}>
                    <div className="top">
                        <Button onClick={() => setFilterOpen(!filterOpen)} className='myBtnFilter' variant="outlined"><KeyboardArrowLeftIcon className='icon' /> Filter</Button>
                        <Paper
                            component="form"
                            className='myInp'
                        >
